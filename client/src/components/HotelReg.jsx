        ...
        <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
            <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
                ...
                <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                    ...
                    onClick={() => setShowHotelReg(false)} /> {/* Fixed the typo here */}
                    <p className='text-2xl font-semiblod mt-6'>Register Your Hotel</p>
                    ...
                    {/* Address */}
                    <div className='w-full mt-4'>
                        <label htmlFor='address' className='font-medium text-gray-500'>Address</label> {/* Fixed label text from "Phone" to "Address" */}
