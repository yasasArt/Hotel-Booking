   ...
   return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 translation-all text-white rounded-md:w-full
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>
                ...
                at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be 
